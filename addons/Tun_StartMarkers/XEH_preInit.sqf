...
[
    ...
    "Tun - Startposition markers & BFT", // Category for the settings menu + optional sub-category <STRING, ARRAY>
...
[
    ...
    ["Create info diary record", "Create diary record that make people notice this addon and how to use"], // Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY>
    "Tun - Startposition markers & BFT", // Category for the settings menu + optional sub-category <STRING, ARRAY>
...
[
    ...
    ["Create info diary record", "Chose language for this."], // Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY>
    "Tun - Startposition markers & BFT", // Category for the settings menu + optional sub-category <STRING, ARRAY>
...
//Settings for starposition markers
[
    ...
    ["Tun - Startposition markers & BFT","Startposition"], // Category for the settings menu + optional sub-category <STRING, ARRAY>
...
[
    ...
    "CHECKBOX", // Type of setting. Can be "CHECKBOX", "EDITBOX", "LIST", "SLIDER" or "COLOR" <STRING>
    ["Add tag if it is AI only squad", "Add tag for squad marker if it is AI squad"], // Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY>
    ["Tun - Startposition markers & BFT","Startposition"], // Category for the settings menu + optional sub-category <STRING, ARRAY>
    true, // Extra properties of the setting depending of _settingType.
    1, // 1: all clients share the same setting, 2: setting can't be overwritten (optional, default: 0) <ARRAY>
    {}, // Script to execute when setting is changed. (optional) <CODE>
